...
import frc.robot.commands.CommandControlDifferential;             
...
public class RobotContainer {
  ...
  private SubsystemDifferential subsystemDifferential = new SubsystemDifferential(0, 0); 
  //
  // Commands
  //
  ...
  private CommandControlDifferential commandControlDifferential = new CommandControlDifferential(subsystemDifferential, 
      primaryController);
  ...
  private void setDefaultCommands() {
    ...
    subsystemDifferential.setDefaultCommand(commandControlDifferential); 
  }
